  ...
  return (
    ...
    <Form>
      ...
      <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
        ...
        <Form.Control as="textarea" rows={3} type="" placeholder="Ticket Description" />
        <Form.Text className="text-muted">
      ...
      <Form.Group className="mb-3" controlId="formBasicPriority">
        ...
        <Form.Text className="text-muted">
         Please indicate the priority level - can make this a selection instead of input.
        </Form.Text>
      </Form.Group>
      ...
      <Form.Group className="mb-3" controlId="formBasicTOC">
        ...
        <Form.Text className="text-muted">
         Please indicate the estimated time of completion for this ticket.
        </Form.Text>
      </Form.Group>
      <Form.Group className="mb-3" controlId="formBasicAssignee">
        ...
        <Form.Text className="text-muted">
         Please indicate the team member to whom you'd like to assign this ticket.
        </Form.Text>
      </Form.Group>
